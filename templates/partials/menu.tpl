			...
			<ul id="logged-in-menu" class="navbar-nav">
				<li class="nav-item dropdown px-2" component="notifications">
					...
					<div class="dropdown-menu" aria-labelledby="notif_dropdown">
						<ul component="notifications/list" class="dropdown-item list-unstyled">
							<li>
				...
				<li class="nav-item dropdown px-2" component="chats">
					<a class="nav-link text-secondary" data-toggle="dropdown" href="{relative_path}/user/{user.userslug}/chats" title="[[global:header.chats]]" id="chat_dropdown" component="chat/dropdown" data-ajaxify="false" role="button">
					...
					<div class="dropdown-menu" aria-labelledby="chat_dropdown">
						<ul class="dropdown-item list-unstyled" component="chat/list">
							<li>
								<i class="fa fa-refresh fa-spin"></i> [[global:chats.loading]]
							</li>
						</ul>
						<div class="dropdown-divider"></div>
						<a class="dropdown-item" href="#" class="mark-all-read" component="chats/mark-all-read">[[modules:chat.mark_all_read]]</a>
				...
				<li id="user_label" class="nav-item dropdown">
					...
					<div id="user-control-list list-unstyled" component="header/usercontrol" class="dropdown-menu" aria-labelledby="user_dropdown">
						...
						<!-- ENDIF showModMenu -->
						<div class="dropdown-divider"></div>
						<div class="dropdown-item" component="user/logout">
